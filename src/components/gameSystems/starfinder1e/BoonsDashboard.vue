...
import Boon from '@/components/gameSystems/starfinder1e/Boon';
import BoonDialog from '@/components/gameSystems/starfinder1e/BoonDialog';

export default {
	name: 'Starfinder1eBoonDashboard',
	components: {
		CharacterDetails,
		Boon,
		BoonDialog,
